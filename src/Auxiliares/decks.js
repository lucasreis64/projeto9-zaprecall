const decks = [
    ...
    [
        ...
        {pergunta: "O que pe sensibilidade dentária?", resposta: "A sensibilidade dentária é em geral, causada pela perda do esmalte, presença de cáries, retração gengival, durante tratamentos de clareamento dental, entre outros. Quando alimentos quentes, frios ou com alto teor de acidez são ingeridos, causam dor e incômodo."},
        ...
        {pergunta: "O que é doença periodontal?", resposta: "São entidades crônicas que não são passíveis de cura, mas somente de um controle. Entretanto, ambas as formas de terapia periodontal (cirúrgica e não cirúrgica) são efetivas em paralisar o processo infeccioso."}
    ],
    [
    ...
    [
        {pergunta: "O que é atrofia?", resposta: "É um termo que descreve a diminuição de tecido celular. Em uma escala maior, a atrofia pode ser uma redução no tamanho e na função de um músculo ou membro. Este processo pode ser muitas vezes gradual e crõnico e até mesmo permanente."},
        {pergunta: "O que é hipertrofia?", resposta: "É o aumento do tamanho de um órgão como consequ~encia do aumento das funções celulares. A hipertrofia mais comum é a muscular, podendo ser provocada por fatores biológicos como: crescimento na fase de puberdade, dilatação do útero durante a gravidez e etc."},
        {pergunta: "O que é hiperplasia?", resposta: "É a proliferação de células em tecidos e órgãos de podem aumentar de volume. Em algumas ocasiões é sintoma de que algo não vai bem com o organismo dopaciente.Isso porque esse aumento no volume de células pode ser estimulado por uma desrregulação de hormônios, fazendo com que tecidos cresçam em lugares errados ou com que órgãos aumentem de tamanho de forma desnecessária."},
